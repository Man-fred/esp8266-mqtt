...
uint8_t BH1745NUC::setTHLimitLow(uint8_t limit)
{
    ...
    limit &= 0xFF;
    writeRegister(bh_i2cAddress, BH1745NUC_CMD_THRESHOLD_HI_LSB, limit);
		return limit;
}
...
uint8_t BH1745NUC::setTHLimitHigh(uint8_t limit)
{
    // mask off the invalid bits in case they were set
    limit &= 0xFF;
    writeRegister(bh_i2cAddress, BH1745NUC_CMD_THRESHOLD_HI_MSB, limit);
		return limit;
}
...
uint8_t BH1745NUC::setTLLimitLow(uint8_t limit)
{
    // mask off the invalid bits in case they were set
    limit &= 0xFF;
    writeRegister(bh_i2cAddress, BH1745NUC_CMD_THRESHOLD_LO_LSB, limit);
		return limit;
}
...
uint8_t BH1745NUC::setTLLimitHigh(uint8_t limit)
{
    // mask off the invalid bits in case they were set
    limit &= 0xFF;
    writeRegister(bh_i2cAddress, BH1745NUC_CMD_THRESHOLD_LO_MSB, limit);
		return limit;
}
